...
/**
 * Uzun çalışan listelerinde isim yazdıkça filtreleyen aranabilir seçici. Native <select>
 * çok firma/çalışan olan projelerde kullanışsız hale geldiği için bunun yerine kullanılır.
 */
function EmployeeCombobox({ employees, value, onChange }) {
  ...
  return (
    <div className="relative" ref={containerRef}>
      <input
        type="text"
        className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 pr-9 text-base outline-none transition focus:ring-2 focus:ring-brand-500"
        placeholder="İsim veya TC no yazarak arayın..."
          ...
          <div>
            ...
            {!form.companyId ? (
              ...
              <div className="space-y-2">
                <EmployeeCombobox employees={companyEmployees} value={employeeId} onChange={setEmployeeId} />
                {!showNewEmployee ? (
                  <button
                    type="button"
